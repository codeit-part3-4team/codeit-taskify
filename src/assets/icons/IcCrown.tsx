 ...
 * Crown (왕관) 아이콘
 *
 * @description 왕관 모양의 아이콘입니다. 대시보드 소유자나 관리자 표시에 사용됩니다.
 *
 * @example
 * ```tsx
 * // 기본 사용
 ...
 * ```
 */
export default function IcCrown({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_20779_46436)">
        <path
